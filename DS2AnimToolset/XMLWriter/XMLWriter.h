...
public:
	 ...
	 */
	static tinyxml2::XMLElement* createElement(tinyxml2::XMLElement* parent, std::string name, std::string text);
	 ...
	 * \return A pointer to the newly created XMLElement, or nullptr if the creation failed.
	 */
	static tinyxml2::XMLElement* createTypedElement(tinyxml2::XMLElement* parent, std::string name, std::string type, std::string text);
	 ...
	 * \return A pointer to the newly created XMLElement, or nullptr if the creation failed.
	 */
	static tinyxml2::XMLElement* createNamedAndTypedElement(tinyxml2::XMLElement* parent, std::string name, std::string attribName, std::string type, std::string text);
