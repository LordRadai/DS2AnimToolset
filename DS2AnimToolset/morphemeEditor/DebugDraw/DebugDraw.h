...
namespace DX
{
    ...
    void XM_CALLCONV DrawBoundingBox(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>* batch,
        DirectX::XMMATRIX world, DirectX::SimpleMath::Vector3 center, DirectX::SimpleMath::Vector3 half_extents,
        DirectX::GXMVECTOR color = DirectX::Colors::DarkRed);
    ...
    void XM_CALLCONV DrawModel(DirectX::PrimitiveBatch<DirectX::VertexPositionNormalColor>* batch,
        DirectX::XMMATRIX world, FlverModel* model);

    void XM_CALLCONV DrawModelWireframe(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>* batch,
