...
namespace ImGui
{
	...
	IMGUI_API void			PathSelection(const char* label, char* v, ImGuiInputFlags flags = 0);
	IMGUI_API void			FileSelection(const char* label, char* v, ImGuiInputFlags flags = 0);
}