...
namespace MD
{
	ME::TakeListXML* exportAnimMarkup(MorphemeCharacterDef* character, int animId, std::wstring dstFileName, std::vector<ME::EventTrackExport*>& exportedDurationTracks);
