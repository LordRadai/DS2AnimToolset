...
namespace MD
{
	namespace Node
	{
		void TransitNodeExportBase::writeDeltaTrajSrouce(MR::NodeDef* nodeDef, ME::DataBlockExportXML* dataBlockExport)
		{
		...
		ME::NodeExportXML* NodeExportTransit::exportNode(ME::NetworkDefExportXML* netDefExport, MR::NetworkDef* netDef, MR::NodeDef* nodeDef, std::string nodeName)
		{
		...
		ME::NodeExportXML* NodeExportTransitSyncEvents::exportNode(ME::NetworkDefExportXML* netDefExport, MR::NetworkDef* netDef, MR::NodeDef* nodeDef, std::string nodeName)
		{
