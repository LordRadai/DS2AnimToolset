...
protected:
  ...
  bool init(MorphemeCharacterDef* characterDef);
...
protected:
  ...
  MorphemeCharacterDef*    m_characterDef;    // The character definition that this class is an instance of.
