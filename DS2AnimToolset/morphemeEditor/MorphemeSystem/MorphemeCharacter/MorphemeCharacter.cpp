...
MorphemeCharacter* MorphemeCharacter::create(MorphemeCharacterDef* networkDef)
{
  ...
  {
    MorphemeCharacter::destroy(instance);
  ...
  if (instance->m_characterDef->getSimulateNetwork())
  {
      //----------------------
...
//----------------------------------------------------------------------------------------------------------------------
void MorphemeCharacter::destroy(MorphemeCharacter* character)
{
  //----------------------------
...
//----------------------------------------------------------------------------------------------------------------------
void MorphemeCharacter::updateWorldTransforms(const NMP::Matrix34& rootTransform)
{
...
//----------------------------------------------------------------------------------------------------------------------
void MorphemeCharacter::runInitialisingUpdateStep()
{
  MR::Task* task;
...
//----------------------------------------------------------------------------------------------------------------------
bool MorphemeCharacter::init(MorphemeCharacterDef* characterDef)
{
