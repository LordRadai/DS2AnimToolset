...
namespace mcd
{
	class Network : public db::Node
	{
		...
		std::unique_ptr<mcd::EmittedControlParametersNode> m_emittedControlParameters;
	...
	public:
		...
		mcd::EmittedControlParametersNode* getEmittedControlParametersNode() const { return m_emittedControlParameters.get(); }
		...
		void addEmittedControlParameter(mcd::EmittedControlParameter* emittedControlParameter) { m_emittedControlParameters->addEmittedControlParameter(emittedControlParameter); }
		mcd::EmittedControlParameter* getEmittedControlParameter(const uint32_t index) const { return m_emittedControlParameters->getEmittedControlParameter(index); }
		mcd::EmittedControlParameter* findEmittedControlParameter(const std::string& name) const { return m_emittedControlParameters->findEmittedControlParameter(name); }
		uint32_t getNumEmittedControlParameters() const { return m_emittedControlParameters->getNumEmittedControlParameters(); }
