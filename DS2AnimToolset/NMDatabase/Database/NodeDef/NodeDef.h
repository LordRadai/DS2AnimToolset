...
namespace db
{
	...
	protected:
		...
		NodeDef(Node* parent, std::string name, std::string identifier, std::string nodeType, int manifestVersion) : Node(parent, identifier, name), m_nodeType(nodeType), m_manifestVersion(manifestVersion) {};
